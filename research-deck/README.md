...
16 slides, ~15 minutes at a normal pace.
...
| 7 — fleet size bands | same, §1.3 |
| 8, 9, 13 — competitors | `business/SwarmOps_Competitive_Battlecard.md` §1, `SwarmOps_Competitor_eyesAtop.md` |
| 10 — TAM | `business/SwarmOps_Market_Sizing.md` §2.1, §9.1 |
| 11, 12 — layers, fleet shapes | `business/SwarmOps_Positioning_and_Pitch.md` §3, `Battlecard` §3.6 |
| 14 — the four observers | `business/SwarmOps_Competitor_eyesAtop.md` §5 |
| 15, 16 — insights and next steps | `business/SwarmOps_Positioning_and_Pitch.md` §9 |
...
2. **Modelled numbers are drawn as bands, never bars.** Slide 7 uses range marks with end-caps for
   exactly this reason: a bar turns an estimate into a measurement.
3. **The 100,000-drone figure is a stated ambition**, drawn dashed and labelled as such. It is not
   an inventory, and no IDF airframe count is public.
4. **The four-observer finding stays bounded.** Four people, one force, dates and roles stated.
   Never "the IDF has no coordination system."
5. **Nothing classified.** If it is not in an open source it does not go in this deck.
6. **The fleet is simulated** wherever our own capability is shown.
